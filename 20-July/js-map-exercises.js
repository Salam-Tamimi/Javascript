...
var array2 = array.map(doubleNumbers);
function doubleNumbers(array2){
  return array2 * 2;
}
console.log(array2)
...
const capital = capitalizeNames(["john", "JACOB", "jinGleHeimer", "schmidt"]);
console.log(capital);
 ...
 *  ["John", "Jacob", "Jingleheimer", "Schmidt"]
 */
const makeStrings= arr.map(function(x){
  if(x.age>=18){
